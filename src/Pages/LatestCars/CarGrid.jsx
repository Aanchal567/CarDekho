...
const cars = [
  ...
  { name: "Toyota Urban Cruiser EBELLA", price: "₹23.60 Lakh*",       spec: "543 km • Electric • 171 bhp",   badge: "Electric",    variants: "1 Variant Launched: May 29, 2026",   hasOffer: false, img: car2  },
  ...
  return (
    <div className="car-grid-section">
      ...
      <p className="section-desc">
        There are 30 cars recently launched in India in last 3 months. Some of the popular latest cars are
